...
const VideoTitle = ({ title, info }) => {
    return (
        ...
        <div className='absolute text-white flex flex-col pt-[20%] pl-[5%] bg-gradient-to-r from-[#000000a3] w-full aspect-video'>
            ...
            <p className='hidden md:flex max-w-[45%] text-lg'>{info}</p>
            <div className="items-center mt-0 md:mt-6 flex">
                <button className="z-10 leading-none text-white whitespace-no-wrap md:w-1/12 w-1/4">
